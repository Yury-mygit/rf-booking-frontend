...
import { setBottomNav, setSubBottomNav, hideSubBottomNav } from "../bottomnav.js";

export { setBottomNav, setSubBottomNav, hideSubBottomNav };
...
//   rest = "/" | "/clients" | "/staff" | "/audit"
//        | "/hotel/<id>" | "/hotel/<id>/status/rooms" | "/room/.../..." | "/client/<id>"
export function activeNavKey(rest) {
  if (rest === "/" || rest === "" || rest.startsWith("/hotel/") || rest.startsWith("/room/")) return "hotels";
