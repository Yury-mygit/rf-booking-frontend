...
const ICON_BOOK = `<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M8 3v4M16 3v4M3 11h18"/><rect x="3" y="5" width="18" height="16" rx="2"/><path d="m9 16 2 2 4-4"/></svg>`;
...
// Bottom-nav клиента. active ∈ {"hotel","rooms","services","book","bookings","hotels"}.
// Контекстные кнопки (hotel/rooms/services/book) берут slug из state.lastHotel;
// если отеля нет — ведут на /client/hotels (выбор). "Забронировать" без href,
// когда не active — её можно открыть только переходом с конкретного номера.
