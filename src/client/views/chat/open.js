...
import { setPendingSubject, setChatReturnHash } from "../../state.js";
...
export async function openChatWithHotel(hotelId, subject) {
  ...
  // Запоминаем откуда пришли (booking details / hotel / rooms /
  // bookings list) — chat back через TG BackButton вернёт сюда.
  setChatReturnHash(location.hash || "#/");
  try {
